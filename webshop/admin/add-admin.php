...
<div class="main-content">
    <div class="wrapper">
        ...
        <br> <br>
        <?php 
             if(isset($_SESSION['add'])) { //check xem session da duoc check hay chua
                echo $_SESSION['add'];
                unset($_SESSION['add']);
            }
        ?>
...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($res==true) {
            $_SESSION['add'] = "admin adress susscesfully";
            header("location:".SITEURL.'admin/manage-admin.php');
        } else {
            // echo "failse to insert";
            $_SESSION['add'] = "failse to add admin";
